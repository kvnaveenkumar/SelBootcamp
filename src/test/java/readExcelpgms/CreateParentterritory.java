...
@Test
	public void tc_CreateParrentterritory() throws IOException {
		...
		name.sendKeys(ReadExcel.excelValue("CreateParentterritory", 1, 0));
		...
		name_NewServiceTerritory.sendKeys(ReadExcel.excelValue("CreateParentterritory", 2, 0));
